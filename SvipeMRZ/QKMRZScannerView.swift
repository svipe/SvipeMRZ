...
public class QKMRZScannerView: UIView {
    ...
    //fileprivate let tesseract = SwiftyTesseract(language: .custom("ocrb"), dataSource: MyDataSource(), engineMode: .tesseractLstmCombined)
    ...
    fileprivate func withDeviceLock(on device: AVCaptureDevice, block: (AVCaptureDevice) -> Void) {
        do {
